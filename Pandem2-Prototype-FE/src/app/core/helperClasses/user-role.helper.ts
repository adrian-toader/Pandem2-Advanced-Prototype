...
export class UserRoleHelper {
  ...
  public static initialize(translateService: TranslateService) {
    UserRoleHelper.translateService = translateService;
  }
  /**
  ...
  public static getCustomPermissionLabel(permissionId: string): string {
    // Modify the permissions array to include custom names
    const customPermissions = UserRoleHelper.translateService.instant(TOKENS.PERMISSIONS[permissionId]) ? UserRoleHelper.translateService.instant(TOKENS.PERMISSIONS[permissionId]) : permissionId;
